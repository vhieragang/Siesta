...
define('E_APP_DATABASE_CONNECTION', 1);
define('E_APP_DATABASE_SELECTION', 2);
define('E_APP_FOUND_ROWS', 3);
define('E_APP_SHOW_COLUMNS', 4);
define('E_APP_GET_REVISION', 5);
define('E_APP_UPDATE_REVISION', 6);
define('E_APP_NO_SYNC_DATA', 7);
define('E_APP_OUTDATED_REVISION', 8);
define('E_APP_GET_OPTION', 9);
define('E_APP_SET_OPTION', 10);
...
class BaseDAO
{
     ...
     */
    public function insert($table, $data, $check_cols = false)
    {
        $cols = null;
     ...
     * @return boolean Returns TRUE in case of successfull query execution and FALSE otherwise.
     */
    public function update($table, $data, $where = null, $check_cols = false)
    {
        $cols = null;

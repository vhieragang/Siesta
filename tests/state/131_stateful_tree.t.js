StartTest(function(t) {
    ...
    function getSchedulerTree () {
        return t.getSchedulerTree({
            ...
            columns     : [
                ...
                { text : 'name', dataIndex : 'Name', width : 100, xtype : 'treecolumn' }
            ],
            id          : 'foo2',         // Must set an id when state should be saved
            stateful    : true,    // State will be saved by the component
            saveDelay   : 0   // saving state is async by default. argh
        });
    }
    var scheduler = getSchedulerTree();
